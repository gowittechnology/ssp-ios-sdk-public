...
Pod::Spec.new do |spec|
  ...
  spec.source            = { :http => "https://github.com/gowittechnology/ssp-ios-sdk-public/blob/main/SDK/sspadkit/sspadkit.zip", :tag => spec.version.to_s }
  ...
  #spec.source_files  = "sspadkit/Public/*.{swift}"
